...
/* ===============================
   HEADINGS — cleaner, sharper
   =============================== */
h1, h2, h3 {
    font-family: "Orbitron", sans-serif !important;
    color: #53F5FF;
    text-shadow: 0 0 6px rgba(83,245,255,0.40);
}
...
/* ===============================
   CARDS — smoother, glassier
   =============================== */
.metric-card {
    background: rgba(15, 22, 35, 0.55);
    border: 1px solid rgba(80,255,255,0.25);
    border-radius: 14px;
    padding: 18px;
    text-align: center;

    box-shadow: 0 0 18px rgba(50,255,255,0.08);
...
.metric-card:hover {
    ...
    box-shadow: 0 0 28px rgba(80,255,255,0.4);
}
...
/* ===============================
   SIDEBAR — cleaner edges
   =============================== */
[data-testid="stSidebar"] {
    background: rgba(8, 12, 22, 0.94);
    border-right: 2px solid rgba(70,180,255,0.28);
    padding-top: 10px;
}
...
/* ===============================
   BUTTONS — more subtle glow
   =============================== */
.stButton > button {
    background: linear-gradient(135deg, #3DF0FF, #007EC3);
    box-shadow: 0 0 10px rgba(61,240,255,0.45);
    border-radius: 9px;
    padding: 10px 20px;
...
/* ===============================
   OPTIONAL: Slight spacing refinements
   =============================== */
.block-container {
...
# ---------------------------
with st.sidebar:
    st.image("Gemini_Generated_Image_odeq68odeq68odeq.png", width=250)
    st.markdown("""
...
# ---------------------------
    ...
    st.image("Screenshot 2025-11-22 204720.png", use_column_width=True)
